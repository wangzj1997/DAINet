...
def paired_crop(x, ref, scale,mask):
    """
    input:
    ...
    fs_crop_lr = np.where(mask == 0, 0,fs)
    ...
    fsref_crop_lr = np.where(mask == 0, 0,fsref)
...
class RefMRIData(data.Dataset):
    def __init__(self, args, name='', train=True, benchmark=False):
        ...
        # print(list_hr)['demodata/mattest/00015_57a9decd4b5dc597.mat', 'demodata/mattest/IXI040-Guys-0724-T2_69.mat']
        # print(os.path.join(self.dir_hr, '*' + self.ext[0]))
        # print(args.ext.find('sep'))

        # print(args.ext.find('bin'))  -1
    ...
    def _set_filesystem(self, dir_data):
        ...
        self.dir_hr = self.apath     #demodata/mattest
        self.ext = ('.mat','.mat')


    def _read_reflist(self, dir_data, ref_list, ref_mat):
        dir_ref = os.path.join(dir_data, ref_mat)    #Data.fastMRIref_mat
        ref_file = os.path.join(dir_data, ref_list)  #Data.multiname.txt
        self.dictref = {}
    ...
    def _load_file(self, idx):
        ...
        hr = sio.loadmat(f_hr)['array']
        
        filename, _ = os.path.splitext(os.path.basename(f_hr))
        filename_withoutdcm = filename.split('.')[0]
        f_ref = self.dictref[filename_withoutdcm]
        # print(filename)IXI040-Guys-0724-T2_69
        # print(filename_withoutdcm)IXI040-Guys-0724-T2_69     
        # print(f_ref)demodata/ref_mat/IXI040-Guys-0724-PD_69.mat   
        refimg = sio.loadmat(f_ref)['array']     
        hr , lr, ref_hr, ref_lr = paired_crop(hr, refimg, (self.scale[self.idx_scale],self.scale2[self.idx_scale]),self.mask)
    ...
    def get_patch(self, lr, hr, ref_hr):
        ...
        if self.train:
            # print(self.args.asymm)False
            # print(self.args.patch_size) 32
            if self.args.asymm:
            ...
            # print(self.args.no_augment)False
